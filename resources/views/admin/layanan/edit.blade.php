...
<div class="max-w-3xl mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-100">Edit Layanan</h1>
    ...
    <form action="{{ route('admin.layanan.update', $layanan->id) }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <textarea name="deskripsi" rows="4"
                      class="w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-200">{{ old('deskripsi', $layanan->deskripsi) }}</textarea>
        </div>

        <div>
            <label class="block mb-1 font-medium">Ikon</label>
